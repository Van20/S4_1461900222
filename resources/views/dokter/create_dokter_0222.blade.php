            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"  name="nama" required="required" class="form-control"  placeholder="Isikan Nama Dokter">
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Jabatan</label>
                        <input type="text" name="jabatan" required="required" class="form-control" placeholder="Isikan Jabatan Dokter">
                    </div>
                    <div><br></div>
                    <div>
